...
const Department = () => {
  ...
  const getData = async () => {
    try {
      const result = await axios.get("https://localhost:7274/api/Department");
      setData(result.data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handleEdit = async (id) => {
    handleOpen();
    const result = await axios.get(`https://localhost:7274/api/Department/${id}`);
    setEditName(result.data.departmentName);
  ...
  const handleUpdate = async () => {
    const url = `https://localhost:7274/api/Department/${editId}`;
    const updateData = {
      id: editId,
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Do you want to delete this Department") === true) {
      const url = `https://localhost:7274/api/Department/${id}`;
      try {
  ...
  const handleSave = async () => {
    const url = "https://localhost:7274/api/Department";
    const data = {
  ...
  return (
    ...
    {/*  <Modal
      ...
      <h1></h1>
    </div>
  );
};
