...
export default function NewsList() {
    ...
    const employeeAPI = (url = 'https://localhost:7017/api/News/') => {
        return {
            fetchAll: () => axios.get(url),
            create: newRecord => axios.post("https://localhost:7017/api/News", newRecord),
    ...
    const imageCard = data => (
        <div className="card" onClick={() => { showRecordDetails(data) }}>
            <img src={data.imageUrl} className="card-img-top rounded-circle" />
